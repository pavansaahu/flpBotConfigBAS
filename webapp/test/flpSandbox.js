		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comdemoflpbot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoflpbot-display": {
								"semanticObject": "comdemoflpbot",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demoflpbot",
									"url": sap.ui.require.toUrl("com/demoflpbot")
								}
							}
						}
					}
